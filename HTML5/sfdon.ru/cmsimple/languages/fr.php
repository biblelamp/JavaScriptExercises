...
$tx['navigator']['top']="haut de page";
$tx['lastupdate']['text']="Dernière mise à jour";
$tx['lastupdate']['dateformat']="M Y";
...
$tx['editmenu']['downloads']="TELECHARGEMENTS";
$tx['editmenu']['help']="AIDE";
$tx['editmenu']['images']="IMAGES";
$tx['editmenu']['logout']="DECONNECTER";
$tx['editmenu']['edit']="MODE EDITION";
$tx['editmenu']['normal']="MODE NORMAL";
$tx['editmenu']['settings']="PARAMETRES";
$tx['editmenu']['validate']="VERIFIER LIENS";
...
$tx['filetype']['template']="squelette";
